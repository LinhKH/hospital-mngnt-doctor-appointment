    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4>View Appointment
                    <a href="{{ url('doctor/appointments') }}" class="btn btn-sm btn-danger float-end">Back</a>
                </h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ url('doctor/appointments/'.$appointment->appointment_number.'/apt-update') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="doctor_comment" class="form-control" placeholder="Write comment..." rows="3">{{ $appointment->doctor_comment }}</textarea>
                        </div>
